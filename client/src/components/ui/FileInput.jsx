...
export default function FileInput({ label, onChange, accept, error, fileName, className }) {
  return (
    <div className={cn('flex flex-col gap-1', className)}>
      ...
      <label
        className={cn(
          'flex cursor-pointer items-center gap-2 rounded-lg border border-dashed px-3 py-2 text-sm text-slate-500 hover:bg-slate-50 dark:text-slate-400 dark:hover:bg-slate-700',
