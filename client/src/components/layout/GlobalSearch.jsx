  ...
  return (
    <form onSubmit={handleSubmit} className="relative hidden max-w-xs flex-1 md:block">
      ...
      <input
        ...
        className="w-full rounded-lg border border-slate-200 bg-slate-50 py-2 pl-9 pr-3 text-sm text-slate-700 placeholder:text-slate-400 focus:border-primary-400 focus:bg-white focus:outline-none focus:ring-4 focus:ring-primary-100"
      />
    </form>
  );
}
