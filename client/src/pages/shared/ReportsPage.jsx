...
import { FiDownload, FiCalendar, FiClock, FiCheckCircle, FiList, FiX } from 'react-icons/fi';
...
export default function ReportsPage() {
  ...
  return (
    <div>
      ...
      {/* Daily-Updates style inline filter row (no card wrapper, no grid) */}
      <div className="mb-6 flex flex-wrap items-center gap-3">
        ...
        {hasActiveFilters && (
          <button
            ...
            className="flex shrink-0 items-center gap-1.5 rounded-lg border border-red-200 bg-red-50 px-3 py-2.5 text-xs font-semibold text-red-600 transition-colors hover:bg-red-100 dark:border-red-800 dark:bg-red-900/30 dark:text-red-400 dark:hover:bg-red-900/50"
